  ...
  TOpcode = (
    ...
    ocCall                 =  13  { RGTR - CALL SP RA    }
    {
      General pseudo opcodes - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        NoOperation              NOOP            => ADDR S0 S0 S0

        Move                     MOVR RD RA      => ADDR RD RA S0

        Return                   RETURN SP       => PULL SP PC

        BranchGreaterThan        BRGT RD RA RB   => BRLE RD RB RA

        BranchGreaterEqualsThan  BRGE RD RA RB   => BRLT RD RB RA

        LoadImmediate            LDW RD -264992  => LDHH RD -364
                                                    ADDH RD 364

        LoadMemory               LDM RD 212686   => LDHH RD 292
                                                    ADDH RD -182
                                                    LDMR RD RD S0
        ...
        StackRelativeLoad        STACK SP RD -1  => ADDQ RD SP -1
                                                    LDMR RD RD S0

      Two-operand functions using DYAD - - - - - - - - - - - - - - - - - - - - -

        LogicalAnd               AND RD RA RB    => LDHH RD 8
                                                    ADDH RD -40
                                                    DYAD RD RA RB

        LogicalNand              NAND RD RA RB   => LDHH RD -8
                                                    ADDH RD 40
                                                    DYAD RD RA RB

        LogicalOr                OR RD RA RB     => LDHH RD 13
                                                    ADDH RD 251
                                                    DYAD RD RA RB

        LogicalNor               NOR RD RA RB    => LDHH RD -13
                                                    ADDH RD -251
                                                    DYAD RD RA RB

        LogicalXor               XOR RD RA RB    => LDHH RD -8
                                                    ADDH RD 8
                                                    DYAD RD RA RB

        LogicalXnor              XNOR RD RA RB   => LDHH RD 8
                                                    ADDH RD -8
                                                    DYAD RD RA RB

        Equality                 TEQ RD RA RB    => LDHH RD 5
                                                    ADDH RD -200
                                                    DYAD RD RA RB

        LessThan                 TLT RD RA RB    => LDHH RD -13
                                                    ADDH RD 146
                                                    DYAD RD RA RB

        LessEqualsThan           TLE RD RA RB    => LDHH RD 5
                                                    ADDH RD 310
                                                    DYAD RD RA RB

        GreaterThan              TGT RD RA RB    => LDHH RD -5
                                                    ADDH RD -310
                                                    DYAD RD RA RB

        GreaterEqualsThan        TGE RD RA RB    => LDHH RD 13
                                                    ADDH RD -146
                                                    DYAD RD RA RB

        Consensus                CSS RD RA RB    => LDHH RD 9
                                                    ADDH RD -1
                                                    DYAD RD RA RB

        AcceptAnything           ANY RD RA RB    => LDHH RD 12
                                                    ADDH RD 212
                                                    DYAD RD RA RB

        KleeneImplication        KIMP RD RA RB   => LDHH RD 8
                                                    ADDH RD 256
                                                    DYAD RD RA RB

        LukasiewiczImplication   LIMP RD RA RB   => LDHH RD 8
                                                    ADDH RD 337
                                                    DYAD RD RA RB

      One-operand functions using DYAD - - - - - - - - - - - - - - - - - - - - -

        NegativeThresholdInvert  NTI RD RA       => LDHH RD -3
                                                    ADDH RD -78
                                                    DYAD RD RA S0

        PositiveThresholdInvert  PTI RD RA       => LDHH RD -3
                                                    ADDH RD 84
                                                    DYAD RD RA S0

        TritwiseIncrement        TWI RD RA       => LDHH RD -3
                                                    ADDH RD 81
                                                    DYAD RD RA S0

        TritwiseDecrement        TWD RD RA       => LDHH RD 0
                                                    ADDH RD -78
                                                    DYAD RD RA S0

        TritwiseIsFalse          TIF RD RA       => LDHH RD -3
                                                    ADDH RD -78
                                                    DYAD RD RA S0

        TritwiseIsUnknown        TIU RD RA       => LDHH RD -3
                                                    ADDH RD 78
                                                    DYAD RD RA S0

        TritwiseIsTrue           TIT RD RA       => LDHH RD 3
                                                    ADDH RD -84
                                                    DYAD RD RA S0

        TritwiseClampDown        TCD RD RA       => LDHH RD 0
                                                    ADDH RD -3
                                                    DYAD RD RA S0

        TritwiseClampUp          TCU RD RA       => LDHH RD 3
                                                    ADDH RD 0
                                                    DYAD RD RA S0
    }
  );
